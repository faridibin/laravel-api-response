...
namespace Faridibin\LaravelJsonResponse\Middleware;
...
use Faridibin\LaravelJsonResponse\Exceptions\ExceptionHandler;
use Faridibin\LaravelJsonResponse\Exceptions\JsonResponseErrorException;
